...
@section('title')
    ...
    <title>Orbits | Program Courses</title>
...
<div class="font-TT mb-2 flex justify-between items-center gap-2 hover:opacity-100 transition-all duration-100">
    ...
    <div class="flex justify-between items-center gap-2">
        ...
        <span class="text-xs opacity-50"><i class="fa-solid fa-chevron-right"></i></span>
        <a href="{{ route('program.courses', ['uuid' => $uuid]) }}" class="opacity-50 hover:opacity-100 transition-all duration-100">
            Courses
        </a>
    </div>
</div>
    ...
    {{-- Livewire Component --}}
    <livewire:program-courses-crud :uuid="$uuid" />
