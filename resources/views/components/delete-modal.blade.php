    ...
    wire:click.self="cancelDelete">
        ...
        class="bg-[#F8F8F8] rounded-lg w-full max-w-lg sm:max-w-md mx-auto relative">
            ...
            <div class="flex flex-col items-center px-6 py-4 text-center">
                ...
                <p class="text-gray-700 text-sm sm:text-base">Are you sure you want to remove this {{ $label }}?</p>
                <p class="text-xs text-gray-500 mt-2 sm:text-sm">This action can be undo if needed.</p>
            </div>
