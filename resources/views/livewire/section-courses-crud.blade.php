        ...
        <div class="flex items-center flex-col md:flex-row w-full md:w-auto">
            ...
            <div class="ml-0 md:ml-5 flex-col flex gap-5 w-full">
                ...
                <div class="py-2 flex justify-between w-full items-center border-b border-[#DDD] gap-5 md:mt-0 mt-5">
                    <span class="font-silka font-semibold text-[#2A2723] text-xl md:text-3xl">{{ $section->section_code }}</span>
                ...
                <div class="text-gray-600">
                    <span class="flex items-center gap-2 justify-start"><img class="w-5" src="{{ asset('assets/icons/course.svg') }}" alt="Course">: <span>{{ $section->courseSection->count() }} Courses</span></span>
