...
class QuestionCriteriaTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('question_criteria')->insert([
            ...
            ['criteria_id' => 5, 'description' => 'Performance of Duties', 'survey_id' => 2],
            ...
            ['criteria_id' => 8, 'description' => 'Self-Awareness', 'survey_id' => 2],
            ['criteria_id' => 9, 'description' => 'Goal Achievement', 'survey_id' => 2],
        ]);
    }
}
